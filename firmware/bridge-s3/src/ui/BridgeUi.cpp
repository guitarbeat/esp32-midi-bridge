...
#include "../transports/ble/BleMidiPeripheral.h"
#include "../hardware/Board.h"
#include "../app/BridgeController.h"
#include "../midi/MidiCodec.h"
#include "../transports/usb/UsbMidiHost.h"
...
void BridgeUi::drawUnifiedMode(uint32_t nowMs)
{
    ...
    drawStatsRow();
    drawLivePanel(104);
    drawVelocityBar(18, 164, 204, 16, bridgeController.engine().state().lastVelocity);
...
{
    const auto& me = bridgeController.engine().state();
