...
void MidiBridge::addTransport(MidiTransport* transport)
{
...
MidiBridge::Result MidiBridge::route(MidiTransport* source, const uint8_t* data, size_t length)
{
...
void MidiBridge::onMidiReceived(MidiTransport* source, const uint8_t* data, size_t length)
{
