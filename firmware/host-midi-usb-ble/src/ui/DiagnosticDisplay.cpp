...
void DiagnosticDisplay::begin(Arduino_GFX* gfx) {
    gfx_ = gfx;
}

void DiagnosticDisplay::setStats(const DiagnosticStats& stats) {
    stats_ = stats;
}

void DiagnosticDisplay::pushLog(const char* text, uint16_t color) {
...
void DiagnosticDisplay::drawLog() {
...
void DiagnosticDisplay::refresh(uint32_t nowMs) {
